...
namespace Sample.Connector.Test
{
    ...
    public class FacebookProviderTest
    {
        ...
        {
            IConnectorSourceProvider sourceProvider = new FacebookProvider(new AzureTableProvider(Settings.StorageAccountConnectionString));
        ...
        {
            FacebookProvider provider = new FacebookProvider(new AzureTableProvider(Settings.StorageAccountConnectionString));
        ...
        public async Task GetUserAccessTokenTest()
        {
            ...
            var restApiRepositoryMock = new Mock<IRestApiRepository>();
            restApiRepositoryMock.Setup(x => x.GetRequestAsync<Dictionary<string, string>>(It.IsAny<string>(), null,
                    It.IsAny<Dictionary<string, string>>(), It.IsAny<CancellationToken>()))
