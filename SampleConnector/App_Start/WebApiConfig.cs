...
namespace Sample.Connector
{
    ...
    public class WebApiConfig
    {
        ...
        {
            Settings.FacebookAppId = (await azureTableProvider.GetEntityAsync<ConfigurationSettingsEntity>(settingsTable, "ConfigurationSetting", "FacebookAppId"))?.settingValue;
            Settings.FacebookAppSecret = (await azureTableProvider.GetEntityAsync<ConfigurationSettingsEntity>(settingsTable, "ConfigurationSetting", "FacebookAppSecret"))?.settingValue;
